---
name: ga2-gestao-diaria
description: "Conduz uma reunião diária curta diante do quadro, destacando avanço, próximo passo e bloqueio. Use quando pedirem diária, daily, trabalhos parados, registro do dia ou remoção de bloqueios."
---
...
- `gestao-diaria-v6` — Gestão Diária (folha individual) (canvas editável v6) — padrão

Para gerar a partir do `.md` preenchido (Python 3.10 ou mais novo, na pasta do pacote):

```bash
python3 construtor/construir.py gestao-diaria-v6 --canvas --md meu-caso.md --saida meu-caso-canvas.html
```
