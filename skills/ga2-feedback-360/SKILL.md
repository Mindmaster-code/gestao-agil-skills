---
name: ga2-feedback-360
description: "Conduz um Feedback 360 com diferentes pontos de vista, padrões e até dois focos com prazo. Use quando pedirem avaliação 360, feedback de líder, pares e equipe ou plano após feedback."
---
...
- `feedback-360-kit-12` — Feedback 360 Graus (canvas do kit do curso) — padrão
- `feedback-360-v6` — Feedback 360 e Roteiro (v6) (canvas editável v6)

Para gerar a partir do `.md` preenchido (Python 3.10 ou mais novo, na pasta do pacote):

```bash
python3 construtor/construir.py feedback-360-kit-12 --documento --md meu-caso.md --saida meu-caso.html
python3 construtor/construir.py feedback-360-kit-12 --canvas --md meu-caso.md --saida meu-caso-canvas.html
```
