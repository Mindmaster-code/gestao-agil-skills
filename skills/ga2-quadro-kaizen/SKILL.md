---
name: ga2-quadro-kaizen
description: "Registra uma melhoria pequena com sinal, aposta, dono, prazo, aprendizado e decisão. Use quando pedirem Kaizen, fila de melhorias, pequeno ajuste ou resposta a indicador parado."
---
...
- `kaizen-v6` — Canvas Editável — Quadro Kaizen do Ciclo (canvas editável v6) — padrão

Para gerar a partir do `.md` preenchido (Python 3.10 ou mais novo, na pasta do pacote):

```bash
python3 construtor/construir.py kaizen-v6 --documento --md meu-caso.md --saida meu-caso.html
python3 construtor/construir.py kaizen-v6 --canvas --md meu-caso.md --saida meu-caso-canvas.html
```
