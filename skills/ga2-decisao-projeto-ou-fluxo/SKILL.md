---
name: ga2-decisao-projeto-ou-fluxo
description: "Escolhe entre projeto em ciclos, fluxo contínuo ou modelo híbrido e define como acompanhar. Use quando perguntarem se o trabalho é projeto ou fluxo, ou quando ciclos não parecem funcionar."
---
...
- `decisao-v6` — Canvas Editável — Decisão: Projeto ou Fluxo (canvas editável v6) — padrão

Para gerar a partir do `.md` preenchido (Python 3.10 ou mais novo, na pasta do pacote):

```bash
python3 construtor/construir.py decisao-v6 --documento --md meu-caso.md --saida meu-caso.html
python3 construtor/construir.py decisao-v6 --canvas --md meu-caso.md --saida meu-caso-canvas.html
```
