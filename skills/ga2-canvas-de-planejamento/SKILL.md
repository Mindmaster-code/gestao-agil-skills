...
- `planejamento-kit` — Canvas de Planejamento (canvas do kit do curso) — padrão
- `planejamento-curso-kit` — Canvas de Planejamento (curso, 9 blocos) (canvas do kit do curso)

Para gerar a partir do `.md` preenchido (Python 3.10 ou mais novo, na pasta do pacote):

```bash
python3 construtor/construir.py planejamento-kit --documento --md meu-caso.md --saida meu-caso.html
python3 construtor/construir.py planejamento-kit --canvas --md meu-caso.md --saida meu-caso-canvas.html
```
