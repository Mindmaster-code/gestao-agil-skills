...
SKILLS: dict[str, Skill] = {
    ...
    "ga2-me-mostra": Skill(
        "Me Mostra",
        "Transforma uma situação de gestão em um visual curto, acionável e sem jargão. Sempre gera HTML e usa o recurso visual disponível. Use para me mostra, desenha, explica visualmente, onde trava, antes e depois ou qual decisão o quadro pede.",
